...
// в swap отвалиться бот если замена уже будет активна в
...
const DEFAULT_VALUES = {
  ...
  lvlMaxEnabled: false,
  highLvlEnabled: false, // отсутствует
  //
  //
  // Погода
...
class SettingsManager {
   ...
   * @param {boolean} [saveToStorage=true] - Сохранять ли в localStorage.
   */
